...
def demo_manual_registration():
    ...
    home = expanduser("~")   
    pcd_data = 'scan03'
    source = o3d.io.read_point_cloud(home+'/Workplace/reactor_head_scan/'+pcd_data+'/'+pcd_data+'.ply',format='ply')  
    pcd_data = 'scan04'    
    target = o3d.io.read_point_cloud(home+'/Workplace/reactor_head_scan/'+pcd_data+'/'+pcd_data+'.ply',format='ply')      
    #source = o3d.io.read_point_cloud("../Open3D/examples/TestData/ICP/cloud_bin_0.pcd")
    #target = o3d.io.read_point_cloud("../Open3D/examples/TestData/ICP/cloud_bin_2.pcd")
